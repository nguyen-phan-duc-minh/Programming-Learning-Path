...
class ApiClient {
            ...
            if (error.response?.status === 401 && !originalRequest._retry) {
                ...
                try {
                    ...
                    if (refreshToken) {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set('access_token', access_token, {
                            expires: 1
                        }); // 1 day
    ...
    async updateTaskProgress(taskId, progress) {
        const response = await this.client.put(`/roadmap/task/${taskId}/progress`, {
            progress
        });
        return response.data;
    }
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initializeAuth = async ()=>{
            try {
                ...
                if (accessToken) {
                    const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getCurrentUser();
                    setUser(userData);
                }
            } catch (error) {
    ...
    const logout = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].logout();
        setUser(null);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c920f6ea._.js.map